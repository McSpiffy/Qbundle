    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        For Each account As clsAccounts.Account In Q.Accounts.AccArray
            If account.AccountName = txtName.Text Then
                MsgBox("You already have an account with that name.", MsgBoxStyle.Exclamation Or MsgBoxStyle.OkOnly,
        ...
        If txtPass.Text.Length < 1 Then
            MsgBox("You need to enter a Burst passphrase for the account.",
                   MsgBoxStyle.Exclamation Or MsgBoxStyle.OkOnly, "No Passphrase")
            Exit Sub
        End If
        If txtPass.Text.Length < 35 Then
            If _
                MsgBox(
                    "Your Burst passphrase is considered as a weak passphrase. You should consider another one. " &
                    vbCrLf & "Do you still want to save it?", MsgBoxStyle.Exclamation Or MsgBoxStyle.YesNo,
                    "Weak account") = MsgBoxResult.No Then
                Exit Sub
            End If
        End If
