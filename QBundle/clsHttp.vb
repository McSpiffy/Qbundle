...
Public Class clsHttp
    ...
    Public Function GetUrl(url As String) As String
        ...
        Try
            ...
            If WebResponse.ContentEncoding.ToLower().Contains("gzip") Then _
                receiveStream = New GZipStream(receiveStream, CompressionMode.Decompress)
            If WebResponse.ContentEncoding.ToLower().Contains("deflate") Then _
    ...
    Public Function PostUrl(url As String, postData As String) As String
        stbuffer = ""
        Errmsg = ""
